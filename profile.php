...
<body>
    ...
    <div class="container">
        ...
        <div class="profileInfoBox">
            ...
            <div class="profileInfo">
                <p class="personality">Playful: <?php echo getTraitLevel($playful); ?>&nbsp;</p>
                <div class="barBack">
                    <div class="barFront" style="width:<?php echo $playful; ?>%"></div>
                </div>
                <p class="personality">Angry: <?php echo getTraitLevel($angry); ?>&nbsp;</p>
                <div class="barBack">
                    <div class="barFront" style="width:<?php echo $angry; ?>%"></div>
                </div>
                <p class="personality">Somber: <?php echo getTraitLevel($somber); ?>&nbsp;</p>
                <div class="barBack">
                    <div class="barFront" style="width:<?php echo $somber; ?>%"></div>
                </div>
                <p class="personality">Independent: <?php echo getTraitLevel($independent); ?>&nbsp;</p>
                <div class="barBack">
                    <div class="barFront" style="width:<?php echo $independent; ?>%"></div>
                </div>
                <p class="personality">Cuddly: <?php echo getTraitLevel($cuddly); ?>&nbsp;</p>
                <div class="barBack">
                    <div class="barFront" style="width:<?php echo $cuddly; ?>%"></div>
                </div>
            </div>
